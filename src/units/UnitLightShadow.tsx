...
export function UnitLightShadow(props: { unit: Unit | null; currentLs: number; setLightShadow: (ls: number) => void }) {
    ...
    <Box sx={{ display: "flex" }}>
      <ClickAwayListener onClickAway={() => setOpened(false)}>
        <div>
          ...
          <Popper open={opened} anchorEl={anchor?.current ?? null} placement={"bottom-start"} transition>
            {({ TransitionProps }) => (
                  ...
                  {!!unit && !!bonuses ? (
                    bonuses.map((b) => (
                      ...
                      >
                        ...
                        >
                          <span>
                            {!!unit ? unit.lightShadow : "-"}
                            {b.lightShadow}
                          </span>
                          <span>
                            {b.statType}+{b.statAmount}
                          </span>
                        </div>
                      </Button>
                    ))
