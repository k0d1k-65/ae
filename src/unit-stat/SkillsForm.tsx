  ...
  return (
    <Grid container>
      <Grid container item xs={12} xl={9}>
        ...
        <EditedOutline
          isEdited={props.default.second.detail !== props.unitStat.second.detail}
          style={{ width: "100%" }}
        >
          <TextField
            sx={{ width: "100%" }}
        ...
        <EditedOutline
          isEdited={props.default.thirdA.detail !== props.unitStat.thirdA.detail}
          style={{ width: "100%" }}
        >
          <TextField
            sx={{ width: "100%" }}
        ...
        <EditedOutline
          isEdited={props.default.thirdB.detail !== props.unitStat.thirdB.detail}
          style={{ width: "100%" }}
        >
          <TextField
            sx={{ width: "100%" }}
        ...
        <EditedOutline
          isEdited={props.default.fifthA.detail !== props.unitStat.fifthA.detail}
          style={{ width: "100%" }}
        >
          <TextField
            sx={{ width: "100%" }}
        ...
        <EditedOutline
          isEdited={props.default.fifthB.detail !== props.unitStat.fifthB.detail}
          style={{ width: "100%" }}
        >
          <TextField
            sx={{ width: "100%" }}
